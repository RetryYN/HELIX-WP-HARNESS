...
assert.deepEqual(audit.disposition_counts,{contract_shape_only:500,provider_dataset_not_acquired:162,request_control_not_1to1_supported:168,response_field_not_1to1_mapped:31,retained_semantic_mapping:91});
