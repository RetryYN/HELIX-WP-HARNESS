...
const decisionLeafOverrides=[/^ai_overview\.references\[\]\./u,/^ai_overview\.items\[\]\./u,/^people_also_ask\.items\[\]\.title$/u,/^related_searches\.items\[\]$/u,/^(?:people_also_ask|related_searches|ai_overview|knowledge_graph|people_also_search|images|video)\.rank_absolute$/u];
...
export function auditSerpDataCoverage(rawRoot=defaultRoot){
  ...
  return {
    schema_version:"serp-data-coverage-audit.v8",raw_files:files.length,
