...
const decisionLeafOverrides=[/^ai_overview\.references\[\]\./u,/^ai_overview\.items\[\]\./u,/^people_also_ask\.items\[\]\.title$/u,/^related_searches\.items\[\]$/u];
...
export function auditSerpDataCoverage(rawRoot=defaultRoot){
  ...
  return {
    schema_version:"serp-data-coverage-audit.v7",raw_files:files.length,
