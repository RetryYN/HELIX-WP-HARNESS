...
assert.deepEqual(audit.raw_leaf_field_summary,{field_count:179,projected_field_count:179,raw_only_field_count:0,decision_connected_field_count:59,evidence_only_field_count:120,consumer_verified_field_count:59,consumer_missing_field_count:0});
...
assert.ok(audit.raw_leaf_fields.some((row)=>row.field==="organic.timestamp"&&row.decision_state==="evidence_only"&&row.consumer===null));
