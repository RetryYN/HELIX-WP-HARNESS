...
assert.equal(audit.schema_version,"serp-data-coverage-audit.v4");
assert.deepEqual(audit.raw_leaf_field_summary,{field_count:179,projected_field_count:179,raw_only_field_count:0,decision_connected_field_count:52,evidence_only_field_count:127});
