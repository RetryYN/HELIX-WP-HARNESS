...
assert.equal(audit.acquired_but_empty_or_incomplete.paa_answer_items,12,"resolved expanded PAA answers must not be miscounted as absent");
...
assert.equal(audit.schema_version,"serp-data-coverage-audit.v9");
assert.deepEqual(audit.raw_leaf_field_summary,{field_count:179,projected_field_count:179,raw_only_field_count:0,decision_connected_field_count:94,evidence_only_field_count:85,consumer_verified_field_count:179,consumer_missing_field_count:0});
