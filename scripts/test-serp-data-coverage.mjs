...
assert.equal(audit.schema_version,"serp-data-coverage-audit.v8");
assert.deepEqual(audit.raw_leaf_field_summary,{field_count:179,projected_field_count:179,raw_only_field_count:0,decision_connected_field_count:85,evidence_only_field_count:94,consumer_verified_field_count:179,consumer_missing_field_count:0});
