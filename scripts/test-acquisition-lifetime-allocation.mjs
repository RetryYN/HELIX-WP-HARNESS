...
const keyword=(id,tier,volume)=>({candidate_digest:id,decision_tier:tier,maximum_retained_search_volume:volume,source_keyword_ids:[id],representative_keyword:id,normalized_keyword:id});
