...
evidence.reproducibility_digest = digest({ tasks: tasks.map(({ source_keyword_id, response_digest }) => ({ source_keyword_id, response_digest })), grouping, articleKeywordGroups });
