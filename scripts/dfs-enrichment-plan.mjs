...
export function buildDfsEnrichmentPlan({siteId,keywords,target,locationCode=2392,languageCode="ja"}){
  ...
  return{schema_version:"dfs-enrichment-plan.v2",site_id:siteId,provider:"DataForSEO",location_code:locationCode,language_code:languageCode,target,keyword_count:uniqueKeywords.length,pricing_basis:{captured_on:"2026-08-26",specs},jobs,estimated_max_usd:round(jobs.reduce((sum,job)=>sum+job.estimated_max_usd,0)),execution_guard:"live requires explicit WP_DFS_ENRICHMENT_LIVE=1, selected jobs, account price snapshot and a sufficient cost ceiling"};
}
