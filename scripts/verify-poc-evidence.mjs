...
assert.equal(headings.schema_version,"wp-heading-attestation.v1");
assert.equal(headings.articles,59);assert.equal(headings.h2,381);assert.match(headings.tree_sha256,/^[a-f0-9]{64}$/);
console.log("required PoC evidence: OK (DFS 100 real KW / 67 groups, GSC 59 articles / 681 queries over 28 days, WP 59 articles / 381 H2)");
