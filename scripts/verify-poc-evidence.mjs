...
assert.equal(keyword.article_keyword_groups.length,63,"real SERP group count after normalization/context hierarchy");
...
console.log(`required PoC evidence: OK (DFS 100 real KW / 63 groups, GSC 59 articles / 681 queries over 28 days, WP 59 articles / ${headings.h2} H2 / ${headings.h3} H3)`);
