...
const acquisitionPreviouslyAttemptedTaskIds=activeRemediation?[...new Set([...activeRemediation.results.map((row)=>row.acquisition_task_id),...(activeRemediation.manifest.rejections??[]).map((row)=>row.source_task_id)])]:[];
