...
const lifetimeAudit=auditAcquisitionLifetimeBudget(remediationRoot,{lifetimeCapUsd:5,plannedMaximumCostUsd:0}),acquisitionLifetimeState={scope:lifetimeAudit.scope,currency:lifetimeAudit.currency,lifetime_cap_usd:lifetimeAudit.lifetime_cap_usd,committed_cost_usd:lifetimeAudit.committed_cost_usd,remaining_budget_usd:lifetimeAudit.remaining_before_run_usd,committed_run_count:lifetimeAudit.committed_run_count,budget_digest:lifetimeAudit.budget_digest};
