...
const db = buildDashboardDb({ dbPath, fixturePath, artifactRoot: fromRepo("artifacts/poc"), importedKeywords, serpAcquiredSourceKeywordIds:poc.tasks.map((row)=>row.source_keyword_id), gscEvidencePaths:availableGscEvidencePaths, headingEvidencePath:hasHeadingEvidence?headingEvidencePath:undefined,contentStructureEvidencePath:availableGscEvidencePaths.length&&existsSync(contentStructureEvidencePath)?contentStructureEvidencePath:undefined, competitorEvidencePath:existsSync(competitorEvidencePath)?competitorEvidencePath:undefined,dfsEnrichmentEvidencePath });
