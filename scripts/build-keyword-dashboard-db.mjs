...
const processedGroups=poc.article_keyword_groups.map((group,index)=>{
  ...
  return {
    ...
    confidence:weakest?(weakest.ratio>=0.8?"high":"possible"):"single",overlap:{shared:weakest?.shared_count??0,depth:5,ratio:weakest?.ratio??0},state:"新規記事候補",wp_article_id:null,category:"IT就活",
