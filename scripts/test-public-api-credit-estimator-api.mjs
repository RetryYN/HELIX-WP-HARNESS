...
assert.equal(researchOpenApi.info.version,"2.63.0");
...
const listed=handleMcpMessage({jsonrpc:"2.0",id:2,method:"tools/list"},data).result.tools;assert.equal(listed.length,69);assert(listed.some((tool)=>tool.name==="estimate_public_api_credits"));
console.log("public API credit estimator API/MCP: OK (API 2.63.0, 69 read-only tools, zero paid requests)");
