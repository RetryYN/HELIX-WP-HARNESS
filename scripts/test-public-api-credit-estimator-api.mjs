...
const listed=handleMcpMessage({jsonrpc:"2.0",id:2,method:"tools/list"},data).result.tools;assert.equal(listed.length,112);assert(listed.some((tool)=>tool.name==="estimate_public_api_credits"));
console.log("public API credit estimator API/MCP: OK (API 2.118.0, 112 read-only tools, zero paid requests)");
