...
fullTests.splice(12,0,"scripts/test-rank-monitor-plan.mjs","scripts/test-rank-monitor-plan-api.mjs","scripts/test-seo-action-queue.mjs","scripts/test-seo-action-queue-api.mjs");
