...
const fullTests=["scripts/test-keyword-lineage-ledger.mjs","scripts/test-keyword-lineage-api.mjs","scripts/test-related-keyword-boundary-oracle.mjs","scripts/test-related-keyword-boundary-api.mjs","scripts/test-suggest-evidence-oracle.mjs","scripts/test-suggest-evidence-api.mjs","scripts/test-question-lineage-oracle.mjs","scripts/test-question-lineage-api.mjs","scripts/test-demand-occurrence-integrity.mjs","scripts/test-demand-occurrence-integrity-api.mjs","scripts/test-simultaneous-rank-integrity.mjs","scripts/test-simultaneous-rank-integrity-api.mjs","scripts/test-variant-evidence-oracle.mjs","scripts/test-variant-evidence-api.mjs","scripts/test-semantic-candidate-review.mjs","scripts/test-semantic-candidate-api.mjs","scripts/test-association-evidence-oracle.mjs","scripts/test-association-evidence-api.mjs","scripts/test-title-serp-pattern-oracle.mjs","scripts/test-heading-serp-pattern-oracle.mjs","scripts/test-heading-serp-pattern-api.mjs",
...
fullTests.splice(12,0,"scripts/test-rank-monitor-plan.mjs","scripts/test-rank-monitor-plan-api.mjs","scripts/test-seo-action-queue.mjs","scripts/test-seo-action-queue-api.mjs","scripts/test-keyword-acquisition-portfolio.mjs","scripts/test-keyword-acquisition-portfolio-api.mjs","scripts/test-title-repair-oracle.mjs","scripts/test-title-repair-api.mjs");
