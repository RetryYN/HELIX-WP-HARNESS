...
const fullTests=["scripts/test-keyword-lineage-ledger.mjs","scripts/test-keyword-lineage-api.mjs","scripts/test-title-serp-pattern-oracle.mjs","scripts/test-heading-serp-pattern-oracle.mjs","scripts/test-heading-serp-pattern-api.mjs",
