...
const schemaVersion = "keyword-dashboard.v15";
const replaceableSchemaVersions=new Set([schemaVersion,"keyword-dashboard.v14","keyword-dashboard.v13","keyword-dashboard.v12","keyword-dashboard.v11","keyword-dashboard.v10","keyword-dashboard.v9","keyword-dashboard.v8","keyword-dashboard.v7"]);
...
export function buildDashboardDb({ dbPath, fixturePath, artifactRoot, importedKeywords = [], gscEvidencePath, headingEvidencePath, competitorEvidencePath }) {
  ...
  db.exec(`
    ...
    DROP TABLE IF EXISTS serp_domain_coverage; DROP TABLE IF EXISTS simultaneous_keyword_relations; DROP TABLE IF EXISTS serp_page_keyword_edges;
