...
const schemaVersion = "keyword-dashboard.v20";
const replaceableSchemaVersions=new Set([schemaVersion,"keyword-dashboard.v19","keyword-dashboard.v18","keyword-dashboard.v17","keyword-dashboard.v16","keyword-dashboard.v15","keyword-dashboard.v14","keyword-dashboard.v13","keyword-dashboard.v12","keyword-dashboard.v11","keyword-dashboard.v10","keyword-dashboard.v9","keyword-dashboard.v8","keyword-dashboard.v7"]);
...
export function buildDashboardDb({ dbPath, fixturePath, artifactRoot, importedKeywords = [], gscEvidencePath, headingEvidencePath, competitorEvidencePath }) {
  ...
  db.exec(`
    ...
    DROP TABLE IF EXISTS serp_feature_occurrences; DROP TABLE IF EXISTS serp_organic_attributes; DROP TABLE IF EXISTS serp_task_metadata;
