...
const proof = {
  serp: {
    artifacts: [
      ...
      "scripts/serp-depth-inventory.mjs",
      "scripts/test-serp-depth-inventory.mjs",
      "scripts/test-serp-depth-inventory-api.mjs",
      "scripts/test-serp-depth-inventory-ui.mjs",
      ...
      "scripts/audit-serp-db-retention.mjs",
      "scripts/build-serp-db-retention-audit.mjs",
      "docs/prototypes/wp-ops-dashboard/serp-db-retention-audit.json",
      "scripts/test-serp-db-retention.mjs",
      "scripts/test-serp-db-retention-api.mjs",
      "scripts/test-serp-db-retention-ui.mjs",
    ],
    verification: [
      ...
      "npm run prototype:serp-depth-inventory:test",
      ...
      "npm run research:serp-db-retention:test",
    ],
  },
  corpus: {
    artifacts: [
      ...
      "scripts/keyword-expansion-lineage.mjs",
      "scripts/related-keyword-boundary-oracle.mjs",
      "scripts/suggest-evidence-oracle.mjs",
      "scripts/suggest-expansion-logic.mjs",
      "scripts/test-suggest-expansion-logic.mjs",
    ...
    verification: [
      ...
      "node scripts/test-keyword-expansion-lineage.mjs",
  ...
  ai: {
    artifacts: [
      ...
      "docs/prototypes/wp-ops-dashboard/citation-application-review-export.mjs",
      "scripts/public-source-citation-application-review-ledger.mjs",
    ...
    verification: [
      ...
      "node scripts/test-public-source-citation-application-review-ledger.mjs",
      "node scripts/test-citation-application-review-ui-export.mjs",
      "node scripts/test-citation-application-review-import.mjs",
  ...
  ui: {
    ...
    verification: [
      ...
      "node scripts/test-serp-db-retention-ui.mjs",
    ],
  },
  contract: {
    artifacts: [
